...
class BengioModel:
    ...
    def create_nn(self):
        ...
        self.embedding_layer = tf.keras.layers.Embedding(
            ...
            trainable=True,
            embeddings_regularizer=tf.keras.regularizers.l2(l2=1e-4)     # It is for weighs(word vectors). l2=.01 is constant multiplied to loss its hyperparameter.
        )
        ...
        self.model.add(tf.keras.layers.Dense(
            ...
            kernel_regularizer=tf.keras.regularizers.l2(l2=1e-4),    # It is for output layer weights i.e. U not biases
            use_bias=True)
        )
